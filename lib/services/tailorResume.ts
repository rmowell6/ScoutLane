...
const TAILOR_INSTRUCTIONS = [
  ...
  'facts, and never invent a number). Name the ACTUAL role title and company from the <job> block in',
  'the opening line; never write "your role" or "your company" generically. Avoid stock openers ("I',
  'hope this finds you well", "I came across", "I was impressed by"); vary sentence length and open',
  'with a short sentence. The LinkedIn note and the email must NOT read like the same message at two',
  'lengths.',
  'outreach.linkedin: a connection request of AT MOST 300 characters. One sentence on why you want to',
  'connect (name the role and company), then one sentence on the single most relevant thing you have',
  'actually done for this kind of work, in plain words (never an acronym list). Conversational;',
